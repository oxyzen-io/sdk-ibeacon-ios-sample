...
@interface CLBeacon (SWIFT_EXTENSION(ZBeaconKit))
@end


@interface CLBeaconRegion (SWIFT_EXTENSION(ZBeaconKit))
@end


@interface CLRegion (SWIFT_EXTENSION(ZBeaconKit))
@end
...
@interface NSDate (SWIFT_EXTENSION(ZBeaconKit))
@end
...
@interface NSNumber (SWIFT_EXTENSION(ZBeaconKit))
@end


@interface UIDevice (SWIFT_EXTENSION(ZBeaconKit))
@end
...
@interface Upload (SWIFT_EXTENSION(ZBeaconKit))
@end
